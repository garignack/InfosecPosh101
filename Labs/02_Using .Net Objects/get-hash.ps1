     ...
     Process
     {
          ...
          if ($file){
               ...
               try {
                    ...
                    $hashAlgorithm.ComputeHash($fileStream) | % { [void] $StringBuilder.Append($_.ToString("x2")) }
               }
               catch {
               ...
               $hashAlgorithm.ComputeHash($ue.GetBytes($text)) | % { [void] $StringBuilder.Append($_.ToString("x2")) }
          }
